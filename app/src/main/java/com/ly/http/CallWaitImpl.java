...
public class CallWaitImpl<T> implements Call<T> {
    ...
    public CallWaitImpl(Request request) {
    ...
    public void block(final Callback<T> callback) {
        ...
        try {
                ...
                if (callback instanceof StringCallbackImpl) {
                    ...
                    ioUtils.read2String(inputStream, "UTF-8", new IOListener<String>() {
                        ...
                        public void onInterrupted() {
                            ...
                            callback.onFail(HttpResponseCode.CODE_THREAD_CANCEL, "线程被取消");
            ...
            HttpUtils.getInstance().removeCall(CallWaitImpl.this);
